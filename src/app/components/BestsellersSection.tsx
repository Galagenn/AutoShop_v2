  ...
  return (
    <section className="pt-10 sm:pt-12 md:pt-14 pb-12 md:pb-24">
      <div className="container-page">
        <div
          className="grid gap-6 items-start md:[grid-template-columns:minmax(240px,42.6%)_minmax(640px,54.1%)]"
        >
          {/* Left large image */}
          ...
          {/* Right content */}
          <div className="flex flex-col justify-between h-full gap-5 order-0 md:order-none">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              {cards.map((c, i) => (
                <div key={i} className="rounded-2xl bg-white text-black p-3 shadow-[inset_0_-2px_0_0_rgba(0,0,0,0.12)] w-full" style={{maxWidth: '198px', height: '256px'}}>
                  ...
                  <div className="relative mt-2 rounded-lg overflow-hidden bg-white h-full w-full"
                       style={{maxWidth:'191px', maxHeight: '150px'}}>
                    <Image 
                      src={`/${c.image}`} 
                      alt={c.title} 
                      fill 
                  ...
                  <div className="mt-2 text-[10px] sm:text-[11px] text-black/70 whitespace-pre-line">
                    {c.specs}
                  </div>
                  <div className="mt-2 flex items-center justify-between">
                    <div className="text-[13px] sm:text-[14px] md:text-[15px] font-extrabold">{c.price}</div>
